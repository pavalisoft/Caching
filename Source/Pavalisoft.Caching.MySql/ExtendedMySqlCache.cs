...
{
    /// <summary>
    /// Provides <see cref="MySqlCache"/> version implementation of <see cref="IExtendedDistributedCache"/>
    /// </summary>
    public class ExtendedMySqlCache : MySqlCache, IExtendedDistributedCache
    {
        /// <summary>
        /// Creates an instance of <see cref="ExtendedMySqlCache"/> with <see cref="MySqlCacheOptions"/>
        /// </summary>
        /// <param name="options"></param>
        public ExtendedMySqlCache(IOptions<MySqlCacheOptions> options) : base(options)
        {
        }
