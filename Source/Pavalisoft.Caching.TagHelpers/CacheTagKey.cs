...
{
    /// <summary>
    /// An instance of <see cref="CacheTagKey"/> represents the state of <see cref="CacheTagHelper"/> keys.
    /// </summary>
    public class CacheTagKey : IEquatable<CacheTagKey>
    {
        ...
        public bool Equals(CacheTagKey other)
        {
            return string.Equals(other.Key, Key, StringComparison.Ordinal) &&
                ...
                string.Equals(other._cachePartition, _cachePartition, StringComparison.Ordinal) &&
                CultureEquals();
        ...
        public override int GetHashCode()
        {
            ...
            hashCodeCombiner.Add(_cachePartition);
